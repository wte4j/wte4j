...
public class TemplateServiceImpl implements TemplateService {
	...
	TemplateDto createTemplateDto(Template<Object> template) {
		...
		dto.setTemplatePath(createTemplatePath(template));

		return dto;
	}

	private String createTemplatePath(Template<Object> template) {
		String queryString = "documentName="
				+ encode(template.getDocumentName()) + "&language="
				+ encode(template.getLanguage());
		return contextPath + "/download/template?" + queryString;
	}
