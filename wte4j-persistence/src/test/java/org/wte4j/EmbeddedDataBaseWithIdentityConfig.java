...
@Configuration
public class EmbeddedDataBaseWithIdentityConfig {
	...
	public void init() {
		database = new EmbeddedDatabaseBuilder()
				...
				.addScript("classpath:sql/create-identity-schema.sql")
				.build();
	}
	...
	public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(){
		...
		localContainerEntityManagerFactoryBean.setPersistenceXmlLocation("classpath:test-identity-persistence.xml");
