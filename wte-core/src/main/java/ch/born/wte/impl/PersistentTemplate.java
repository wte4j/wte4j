...
/**
 * Persistent data of a WTE-Template
 */
@Entity
...
public class PersistentTemplate {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "wte_gen")
	private Long id;
	...
	@CollectionTable(name = "wte_template_properties", joinColumns = @JoinColumn(name = "template_id"))
	...
	/**
	 * Writes the template document to the given output stream and closes it
	 * 
	 * @param out
	 *            - the Outputstream
	 * @throws IOException
